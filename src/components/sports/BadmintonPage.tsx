            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-gradient-to-r from-[#89D3EC] to-blue-500 rounded-full text-white font-bold text-lg shadow-lg"
                >
                  Start Free Trial
                </motion.button>
                <motion.button
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-r from-[#89D3EC] to-blue-500 rounded-xl flex items-center justify-center mb-4">
