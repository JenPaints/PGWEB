...
interface TennisPageProps {
  onBack: () => void;
}

const TennisPage = ({ onBack }: TennisPageProps) => {
  const features = [
    {
      icon: Target,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h1 className="text-5xl md:text-6xl font-bold">
                  <span className="bg-gradient-to-r from-green-500 to-lime-600 bg-clip-text text-transparent">
                    Tennis
                  </span>
                  <br />
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Master the court with precision training in serves, volleys, footwork, 
                and strategic play for singles and doubles.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-gradient-to-r from-green-500 to-lime-600 rounded-full text-white font-bold text-lg shadow-lg"
                >
                  Start Free Trial
                </motion.button>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 border-2 border-green-500 text-green-500 rounded-full font-bold text-lg hover:bg-green-500 hover:text-white transition-all"
                >
                  View Programs
                </motion.button>
              </div>
            ...
            >
              <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-700 rounded-3xl overflow-hidden relative">
                <img
                  src="https://images.unsplash.com/photo-1587182717006-258284561701?w=800"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive tennis training for technique, strategy, and competitive excellence
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-gray-800/50 to-gray-700/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-600/30 hover:border-blue-400/30 transition-all"
              >
                <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-lime-600 rounded-xl flex items-center justify-center mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {coaches.map((coach, index) => (
              ...
              >
                ...
                <p className="text-blue-400 font-semibold mb-1">{coach.experience}</p>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-blue-400 to-[#89D3EC] rounded-full text-white font-bold text-lg shadow-lg"
              >
                Start Free Trial
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-blue-400 text-blue-400 rounded-full font-bold text-lg hover:bg-blue-400 hover:text-white transition-all"
              >
                Contact Coach
              </motion.button>
            </div>
